...
class LangFile:
    ...
    PATH_LOCAL_FILE = '../translation/Translation String_%s.xlsx'  # path to file + file name
    SHEET_NAME = 'Multi'
    ...
    def __init__(self, langCode):
        self.LANGUAGE_SUPPORTED.append(langCode)
        self.COLUMNS_TO_PARSE.append(self.LANGUAGE_SUPPORTED[0])

    def read_file_content(self):
        file_path = self.PATH_LOCAL_FILE % (self.LANGUAGE_SUPPORTED[0])
        ...
        # print('---------------------------------')
        # print(content)
        # print(self.LANGUAGE_SUPPORTED)
        # print(self.COLUMNS_TO_PARSE)
        # print(file_path)
        # print('=================================')
