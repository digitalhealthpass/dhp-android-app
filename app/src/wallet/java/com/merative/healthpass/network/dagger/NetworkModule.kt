...
import com.merative.healthpass.network.interceptors.SamsungPayHeadersInterceptor
...
class NetworkModule {
    ...
    fun provideSamsungRetrofit(
        ...
        val client = httpBuilder.apply{
            addInterceptor(SamsungPayHeadersInterceptor())
        }.build()
    ...
    fun provideLoginInterceptor(
        ...
        return LoginInterceptor(sharedPrefUtils, environmentHandler)
    }
