package com.merative.healthpass.ui.thirdParty
...
import com.merative.healthpass.databinding.FragThirdPartyBinding
import com.merative.healthpass.extensions.*
import com.merative.healthpass.ui.common.baseViews.BaseFragment
import java.io.BufferedReader

class ThirdPartyNoticeFragment : BaseFragment() {
    private var _binding: FragThirdPartyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragThirdPartyBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initWebView() {
        ...
        val text = activity?.let { readAsset(it, FILE_NAME_THIRD_PARTY) }
    ...
    companion object {
        ...
        const val FILE_NAME_THIRD_PARTY = "third_party_notice.html"
    }
}