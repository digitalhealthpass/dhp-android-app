...
import com.merative.healthpass.network.repository.DisplayFieldsRepo
...
class FlavorModule {
    ...
    @Provides
    fun provideDisplayFieldRepo(context: Context): DisplayFieldsRepo {
        return DisplayFieldsRepo(context)
    }
